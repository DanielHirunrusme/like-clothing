...
var makeVideoPlayableInline=require("iphone-inline-video"),mousewheel=require("jquery-mousewheel")($);module.exports=function(e){function o(){clearInterval(a);var e=w.scrollTop();w.hasClass("looped")&&(w.removeClass("looped"),e>h.height()&&w.removeClass("looped")),e>=w[0].scrollHeight-h.height()&&($(".wrapper").addClass("looped"),w.animate({scrollTop:0},0),w.scrollTop(0),$(".top-section.bottom-fixed").css("opacity",0))}function i(){var e=w.scrollTop();if(w.hasClass("looped")){if(e<2*h.height()){var o=e-h.height()+e/h.height()*1;console.log("op "+o),$("#color-overlay").css("opacity",o)}}else if(e<h.height()){var o=e/h.height()*1;console.log("op "+o),$("#color-overlay").css("opacity",o)}if(e>=w[0].scrollHeight-2*h.height()){console.log((w[0].scrollHeight-e-h.height())/h.height());var o=(w[0].scrollHeight-e-h.height())/h.height();$("#color-overlay").css("opacity",o),$(".top-section.bottom-fixed").css("opacity",1-o)}}function l(){s(),i(),$("#video-container").fadeIn(6e3),d=setTimeout(function(){m=!0},2e3),r(function(e){g-=.2,u-=.2,$(".video-scroll").css({"-webkit-transform":"translate("+g+"px,0)","-ms-transform":"translate("+g+"px,0)",transform:"translate("+g+"px,0)"}),m&&(o(),i(),w.scrollTop(w.scrollTop()+1)),t()}),h.on("resize",n)}function t(){if(g<-v){g=0,u=0,p.append($(".video-holder").eq(0));for(var e=0;e<$(".video-holder").length;e++)$(".video-holder").eq(e).css("left",f*e+"px");return $(".video-holder").eq(1).find("video")[0].play(),console.log("reset entire piece"),!0}if(u<-f){u=0;var o=Number($(".video-holder").last().css("left").split("px").join(""))+f;$(".video-holder").eq(2).find("video")[0].play(),$(".video-holder").eq(0).find("video")[0].pause(),$(".video-holder").eq(0).css("left",o+"px"),p.append($(".video-holder").eq(0))}}function s(){v=0,$(".video-holder").each(function(){$(this).css("left",$(this).width()*$(this).index()),v+=$(this).width()}),p.css("width",v)}function r(e,o){function i(s){l!==!1&&(requestAnimationFrame(i,o),l=e(s-t),t=s)}var l,t=+new Date;i(t)}function n(){f=$(".video-holder").width(),s()}var a,d,c=$(e),h=$(window),p=c.find(".video-scroll"),f=$(".video-holder").width(),v=0,u=0,g=0,m=!1,w=$(".wrapper");console.log("%c[video module init]","color:blue;"),$("video").each(function(){makeVideoPlayableInline(this)}),w.on("mousewheel",function(e){console.log("mousewheel triggered"),m=!1,clearTimeout(d),d=setTimeout(function(){m=!0},1e4)}),w.on("scroll",function(e){e.stopPropagation(),console.log("scroll triggered"),o(),i(),e.deltaY<0&&(g+=e.deltaY,u+=e.deltaY),e.deltaX>1&&(g-=e.deltaX,u-=e.deltaX),t(),$("body").addClass("scrolling"),clearTimeout($.data(this,"timer")),$.data(this,"timer",setTimeout(function(){$("body").removeClass("scrolling")},250))}),l()};
